# 🧠 Memoria del Proyecto - Agents_IA_TECH (Copia para Plataformador)

> **Copia de referencia** para el agente `plataformador`.  
> La versión maestra está en `Documentacion/Agents_IA_TECH/memoria-proyecto.md`.
...
| `Documentacion/Agents_IA_TECH/agents/plataformador/capacidad-base.md` | Existe | ✅ Creada (esta copia) | OK |
| `Documentacion/Agents_IA_TECH/agents/plataformador/memoria-proyecto.md` | Existe | ✅ Creada (esta copia) | OK |
...
1. Instalar y configurar `codebase-memory-mcp` para agentes
2. Definir integración explícita Pensador ↔ Specify skills
3. Implementar sistema de persistencia de sesiones en disco (`sesiones/`)
...
| 2026-08-30 | 1.1.0 | Reestructuración completa | Movido a Documentacion/Agents_IA_TECH/, análisis Specify vs Agentes, nueva estructura, complementariedad definida |